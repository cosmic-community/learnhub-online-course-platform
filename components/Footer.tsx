  ...
  return (
    <footer className="bg-navy-900/50 border-t border-navy-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-navy-400 mb-4 max-w-md">
              Empowering learners worldwide with expert-led courses in web development, 
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/quiz" className="text-navy-400 hover:text-primary-400 transition-colors flex items-center gap-1">
        ...
        <div className="border-t border-navy-800 mt-8 pt-8 text-center text-navy-500">
