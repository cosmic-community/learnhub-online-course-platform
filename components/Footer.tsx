...
export default function Footer() {
  ...
  return (
    <footer className="bg-navy-900/50 border-t border-navy-800 relative overflow-hidden">
      {/* Decorative gradient */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex gap-3">
              <a href="#" className="w-10 h-10 rounded-full bg-navy-800 hover:bg-primary-500/20 border border-navy-700 hover:border-primary-500/50 flex items-center justify-center text-navy-400 hover:text-primary-400 transition-all">
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/courses" className="text-navy-400 hover:text-primary-400 transition-colors flex items-center gap-2 group">
                  <span className="w-1 h-1 rounded-full bg-navy-600 group-hover:bg-primary-500 transition-colors" />
                  All Courses
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/categories/web-development" className="text-navy-400 hover:text-primary-400 transition-colors flex items-center gap-2 group">
                  <span className="w-1 h-1 rounded-full bg-navy-600 group-hover:bg-primary-500 transition-colors" />
                  💻 Web Development
                </Link>
              </li>
              <li>
                <Link href="/categories/cloud-computing" className="text-navy-400 hover:text-primary-400 transition-colors flex items-center gap-2 group">
                  <span className="w-1 h-1 rounded-full bg-navy-600 group-hover:bg-primary-500 transition-colors" />
                  ☁️ Cloud Computing
                </Link>
              </li>
              <li>
                <Link href="/categories/mobile-development" className="text-navy-400 hover:text-primary-400 transition-colors flex items-center gap-2 group">
                  <span className="w-1 h-1 rounded-full bg-navy-600 group-hover:bg-primary-500 transition-colors" />
                  📱 Mobile Development
                </Link>
              </li>
