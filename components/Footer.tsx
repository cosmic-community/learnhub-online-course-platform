          ...
          <div className="md:col-span-2">
            ...
            <div className="flex gap-4">
              <a 
                ...
                className="w-10 h-10 bg-navy-800 rounded-lg flex items-center justify-center text-navy-400 hover:bg-primary-500 hover:text-white transition-all duration-300"
              >
