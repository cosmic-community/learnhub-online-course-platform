    ...
    <div className="mt-16 grid grid-cols-2 md:grid-cols-5 gap-6 max-w-4xl mx-auto">
      {stats.map((stat, index) => (
        <div 
          key={stat.label}
          ref={stat.ref}
          className="text-center p-4 rounded-xl bg-navy-900/50 border border-navy-800 hover:border-primary-500/30 transition-all duration-300 hover:scale-105 group"
          style={{ animationDelay: `${index * 100}ms` }}
        >
          <div className="flex justify-center mb-2 text-primary-400 opacity-60 group-hover:opacity-100 transition-opacity">
            {stat.icon}
          </div>
