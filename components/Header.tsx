      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <button
            ...
            className="md:hidden p-2 text-navy-300 hover:text-white rounded-lg hover:bg-navy-800 transition-colors"
        ...
        <div className={`md:hidden overflow-hidden transition-all duration-300 ${
          ...
          <nav className="flex flex-col gap-2 border-t border-navy-800 pt-4">
            <Link
              href="/courses"
              className="text-navy-300 hover:text-white hover:bg-navy-800 transition-colors py-2 px-3 rounded-lg"
