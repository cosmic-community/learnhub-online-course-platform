  ...
  return (
    <header className={`sticky top-0 z-50 transition-all duration-300 ${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Mobile Menu */}
        <div className={`md:hidden overflow-hidden transition-all duration-300 ${isMobileMenuOpen ? 'max-h-64 py-4' : 'max-h-0'}`}>
          <nav className="flex flex-col gap-4 border-t border-navy-800 pt-4">
            <Link
              href="/courses"
