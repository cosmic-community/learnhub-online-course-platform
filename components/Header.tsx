...
export default function Header() {
  ...
  return (
    <header className={`sticky top-0 z-50 transition-all duration-300 ${scrolled ? 'bg-navy-950/95 backdrop-blur-lg shadow-lg shadow-navy-950/50' : 'bg-navy-950/80 backdrop-blur-lg'} border-b border-navy-800`}>
