...
export default async function CoursePage({ params }: CoursePageProps) {
  ...
  return (
    <div>
      {/* Track this course view for personalization */}
      <CourseViewTracker courseSlug={course.slug} courseTitle={course.title} />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div>
              ...
              {instructors.length > 0 && (
                <div className="mb-8">
                  <h3 className="text-sm text-navy-400 mb-3">Instructor{instructors.length > 1 ? 's' : ''}</h3>
