...
export default async function HomePage() {
  ...
  // Pick a random course for spotlight (different each day based on date)
  const today = new Date()
  const dayOfYear = Math.floor((today.getTime() - new Date(today.getFullYear(), 0, 0).getTime()) / 86400000)
  const spotlightIndex = dayOfYear % courses.length
  const spotlightCourse = courses[spotlightIndex] || courses[0]
  ...
  return (
    <div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary-500/10 border border-primary-500/20 mb-6 animate-fade-in">
              ...
              <span className="text-primary-300 text-sm font-medium">Welcome back, learner!</span>
            </div>
      ...
      {/* Learning Streak + Course Spotlight Section */}
      <section className="py-12 border-b border-navy-800/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <LearningStreak />
            {spotlightCourse && <CourseSpotlight course={spotlightCourse} />}
          </div>
        </div>
      </section>
