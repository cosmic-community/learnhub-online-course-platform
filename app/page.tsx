...
export default async function HomePage() {
  ...
  return (
    <div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <Link href="/courses" className="btn-primary text-lg animate-bounce-gentle">
                  Browse Courses
                </Link>
            ...
            {/* Right Column - Learning Streak Widget */}
      ...
      {/* Mobile Learning Streak - Shows only on mobile */}
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="card p-12 relative overflow-hidden">
            {/* Animated background */}
            <div className="absolute inset-0 bg-gradient-to-r from-primary-500/10 via-transparent to-primary-500/10 animate-shimmer" />
            ...
            <div className="relative">
              ...
              <Link href="/courses" className="btn-primary text-lg inline-flex items-center gap-2 animate-glow">
                Get Started Now
