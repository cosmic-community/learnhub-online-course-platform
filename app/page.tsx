...
export default async function HomePage() {
  ...
  // Calculate total learning time available
  ...
  return (
    <div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-primary-500/10 border border-primary-500/20 rounded-full px-4 py-2 mb-6 animate-fade-in">
              ...
              <span className="text-primary-300 text-sm font-medium">Live learning platform</span>
            </div>
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
            ...
            <div className="stat-card group">
              ...
              <div className="stat-bar">
                <div className="stat-bar-fill bg-green-500/50" style={{ width: '60%' }} />
              </div>
            </div>
            ...
            <div className="stat-card group">
              ...
              <div className="stat-bar">
                <div className="stat-bar-fill bg-yellow-500/50" style={{ width: '85%' }} />
              </div>
            </div>
            ...
            <div className="stat-card group">
              ...
              <div className="stat-label">Learning Content</div>
              <div className="stat-bar">
                <div className="stat-bar-fill bg-purple-500/50" style={{ width: '70%' }} />
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Learning Progress Section - Client-side with local storage */}
      <section className="py-12 border-b border-navy-800/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <LearningProgress coursesCount={courses.length} />
        </div>
      </section>

      {/* Motivational Quote */}
      <section className="py-8 bg-gradient-to-r from-primary-900/20 via-navy-900/50 to-primary-900/20">
          ...
          <div className="flex items-center justify-between mb-12">
            <div>
              <div className="flex items-center gap-3 mb-2">
                <span className="inline-flex items-center justify-center w-8 h-8 bg-primary-500/20 rounded-lg">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <div className="inline-flex items-center justify-center w-12 h-12 bg-primary-500/20 rounded-2xl mb-4">
