...
export default async function HomePage() {
  ...
  const courseOfTheDayIndex = dayOfYear % courses.length
  const courseOfTheDay = courses[courseOfTheDayIndex]
  ...
  return (
    <div>
      ...
      {/* Learning Paths */}
      <LearningPaths categories={categories} courses={courses} />
      ...
      <section className="py-20 bg-navy-900/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-navy-400">What makes LearnHub different</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="card p-8 text-center group hover:bg-navy-800/50 transition-all">
              <div className="w-16 h-16 mx-auto mb-6 bg-primary-500/10 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform">
                <span className="text-3xl">🎯</span>
              </div>
              <h3 className="text-xl font-semibold text-white mb-3">Project-Based Learning</h3>
              <p className="text-navy-400">Build real projects while learning. Apply your skills immediately with hands-on exercises.</p>
            </div>
            ...
            <div className="card p-8 text-center group hover:bg-navy-800/50 transition-all">
              ...
              <p className="text-navy-400">Learn from industry professionals with real-world experience at top tech companies.</p>
            </div>
            ...
            <div className="card p-8 text-center group hover:bg-navy-800/50 transition-all">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">Career-Ready Skills</h3>
              <p className="text-navy-400">Gain skills that employers are looking for. Our curriculum is designed for the job market.</p>
            </div>
          </div>
        </div>
      </section>
