  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute bottom-20 left-20 text-3xl animate-float delay-2000 opacity-20">🎯</div>
        
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="grid lg:grid-cols-3 gap-12 items-center">
            {/* Left side - Hero content */}
            <div className="lg:col-span-2 text-center lg:text-left">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary-500/10 border border-primary-500/20 rounded-full text-primary-400 text-sm font-medium mb-6 animate-pulse-slow">
              ...
              <p className="text-xl text-navy-300 mb-8 max-w-2xl">
              ...
              <div className="mt-12 grid grid-cols-3 gap-6 max-w-md lg:max-w-none">
            ...
            {/* Right side - Learning Motivation Widget */}
