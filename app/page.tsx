    ...
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute bottom-40 left-1/4 w-2 h-2 bg-primary-300/25 rounded-full animate-float-slow" />
          <div className="absolute top-1/3 right-1/3 w-4 h-4 bg-primary-400/15 rounded-full animate-pulse-slow" />
        </div>
        
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-primary-500/10 border border-primary-500/20 rounded-full px-4 py-2 mb-6 animate-fade-in-down">
            ...
            <p className="text-xl text-navy-300 mb-8 animate-fade-in-up">
      ...
      {/* Daily Learning Tip */}
      <section className="py-6 bg-gradient-to-r from-primary-500/5 via-primary-500/10 to-primary-500/5 border-y border-primary-500/10">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 bg-yellow-500/10 border border-yellow-500/20 rounded-full px-4 py-2 mb-4">
              ...
              <span className="text-yellow-300 text-sm font-medium">Personalized for you</span>
            </div>
            <h2 className="text-3xl font-bold text-white mb-2">Find Your Perfect Learning Path</h2>
            <p className="text-navy-400">Answer a few quick questions and we&apos;ll recommend the best courses for you</p>
          </div>
