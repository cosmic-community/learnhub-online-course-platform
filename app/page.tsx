          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8 max-w-3xl mx-auto">
            <div className="text-center group">
              <AnimatedCounter 
                ...
                suffix="+" 
                className="text-3xl font-bold text-white group-hover:text-primary-400 transition-colors"
              />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="card p-12 bg-gradient-to-br from-primary-500/10 to-navy-900/50 border-primary-500/20">
            ...
            <p className="text-navy-300 mb-8 text-lg max-w-xl mx-auto">
              ...
              Track your progress, earn achievements, and grow your expertise.
            </p>
