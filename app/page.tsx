          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="card p-6 text-center group hover:border-primary-500/50">
              ...
              <p className="text-navy-400 text-sm">
                Build real projects while you learn. Apply skills immediately to reinforce your understanding.
              </p>
            </div>
            ...
            <div className="card p-6 text-center group hover:border-primary-500/50">
              ...
              <p className="text-navy-400 text-sm">
                Stay motivated with learning streaks, daily challenges, and milestone celebrations.
              </p>
            </div>
          </div>
        </div>
