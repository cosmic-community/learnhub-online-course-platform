  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute bottom-40 right-10 text-4xl animate-float opacity-20" style={{ animationDelay: '1.5s' }}>🚀</div>
      ...
      <section className="py-12 bg-gradient-to-r from-primary-500/5 via-navy-900/50 to-primary-500/5">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-6">
            <span className="text-sm text-primary-400 font-medium uppercase tracking-wider">💡 Daily Inspiration</span>
          </div>
          <MotivationalQuote />
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-navy-400">Everything you need for your learning journey</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center group">
              <div className="w-16 h-16 mx-auto mb-4 bg-primary-500/10 rounded-2xl flex items-center justify-center group-hover:bg-primary-500/20 transition-colors">
                <span className="text-3xl">🎯</span>
              </div>
              <h3 className="text-lg font-semibold text-white mb-2">Practical Skills</h3>
              <p className="text-navy-400 text-sm">Learn real-world skills with hands-on projects and exercises</p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-navy-400 text-sm">Learn from professionals at top tech companies</p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-navy-400 text-sm">Access courses on any device, anytime you want</p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-navy-400 text-sm">Earn achievements and maintain learning streaks</p>
            </div>
          </div>
        </div>
      </section>
