...
export default async function HomePage() {
  ...
  return (
    <div>
      ...
      {/* Learning Streak & Quick Tip Section */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              ...
              {/* Quick Actions Card */}
              <div className="card p-5 bg-gradient-to-r from-purple-900/30 to-indigo-900/30 border-purple-500/20">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <Link 
                    href="/courses" 
                    className="flex items-center gap-2 p-3 bg-navy-800/50 hover:bg-navy-700/50 rounded-lg transition-colors group"
                  >
                    <span className="text-xl">📚</span>
                    <span className="text-sm text-navy-200 group-hover:text-white transition-colors">Browse Courses</span>
                  </Link>
                  <Link 
                    href="/categories" 
                    className="flex items-center gap-2 p-3 bg-navy-800/50 hover:bg-navy-700/50 rounded-lg transition-colors group"
                  >
                    ...
                    <span className="text-sm text-navy-200 group-hover:text-white transition-colors">Categories</span>
                  </Link>
                  <Link 
                    href="/contact" 
                    className="flex items-center gap-2 p-3 bg-navy-800/50 hover:bg-navy-700/50 rounded-lg transition-colors group"
                  >
                    <span className="text-xl">💬</span>
                    <span className="text-sm text-navy-200 group-hover:text-white transition-colors">Get Help</span>
                  </Link>
                  <div className="flex items-center gap-2 p-3 bg-navy-800/50 rounded-lg cursor-default">
                    <span className="text-xl">🎯</span>
                    <span className="text-sm text-navy-400">Set Goals (Soon)</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 bg-gradient-to-r from-primary-900/20 to-purple-900/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <p className="text-navy-300 mb-6">Trusted by learners worldwide</p>
