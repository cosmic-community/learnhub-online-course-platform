...
export default async function HomePage() {
  ...
  return (
    <div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary-500/10 border border-primary-500/20 rounded-full text-primary-400 text-sm font-medium mb-6">
              ...
              Now with interactive progress tracking!
            </div>
      ...
      {/* Gamification Feature Highlight */}
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="card p-8 bg-gradient-to-br from-primary-900/50 to-purple-900/50 border-primary-700/50">
            <div className="flex flex-col md:flex-row items-center gap-8">
              <div className="text-6xl animate-float">🎯</div>
              <div className="text-center md:text-left">
                <h3 className="text-2xl font-bold text-white mb-2">Track Your Learning Journey</h3>
                <p className="text-navy-300 mb-4">
                  Our new progress tracker celebrates your achievements as you explore courses. 
                  Build streaks, hit milestones, and watch confetti fly! 🎉
                </p>
                <p className="text-sm text-navy-400">
                  Look for the progress button in the bottom-left corner →
                </p>
              </div>
            </div>
          </div>
