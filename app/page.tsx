...
export default async function HomePage() {
  ...
  // Get a "course of the day" based on the current date
  ...
  return (
    <div>
      ...
      {/* Featured Courses */}
      <section id="featured" className="py-20 bg-navy-900/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {/* Instructors */}
      <section id="instructors" className="py-20 bg-navy-900/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-white mb-2 flex items-center justify-center gap-3">
              <span className="text-4xl">👨‍🏫</span>
      ...
      <section className="py-16 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          ...
          <blockquote className="text-2xl md:text-3xl font-light text-navy-200 italic mb-4">
            &ldquo;The beautiful thing about learning is that no one can take it away from you.&rdquo;
          </blockquote>
          <cite className="text-primary-400 font-medium">— B.B. King</cite>
        </div>
      </section>
