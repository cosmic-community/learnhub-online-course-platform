    ...
    <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="card p-8 text-center group hover:scale-105 transition-transform duration-300">
              ...
              <p className="text-navy-400">
                Access courses anytime, anywhere. Track your progress with our streak system and celebrate milestones along the way.
              </p>
            </div>
            <div className="card p-8 text-center group hover:scale-105 transition-transform duration-300">
              <div className="text-5xl mb-4 group-hover:scale-110 transition-transform duration-300">👨‍🏫</div>
              ...
              <p className="text-navy-400">
                Learn from industry professionals with years of real-world experience at top tech companies.
              </p>
            </div>
            <div className="card p-8 text-center group hover:scale-105 transition-transform duration-300">
              <div className="text-5xl mb-4 group-hover:scale-110 transition-transform duration-300">💻</div>
              ...
              <p className="text-navy-400">
                Build real projects with code examples and exercises that you can add to your portfolio.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="card p-12 bg-gradient-to-br from-navy-900/80 to-navy-900/40">
            ...
            <p className="text-navy-300 mb-8 text-lg">
              ...
              Build your streak and watch your knowledge grow!
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/courses" className="btn-primary text-lg">
                Get Started Now
