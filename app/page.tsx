      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center max-w-3xl mx-auto">
            {/* Animated badge */}
            <div className="inline-flex items-center gap-2 bg-primary-500/10 border border-primary-500/20 rounded-full px-4 py-2 mb-6 animate-pulse">
              <span className="text-primary-400 text-sm font-medium">🎉 New: Track your progress with achievements!</span>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="text-center md:text-left">
              ...
              <p className="text-white/80">Earn achievements, build streaks, and watch your skills grow!</p>
            </div>
            <div className="flex items-center gap-4">
              <div className="flex -space-x-2">
                {['🏆', '🔥', '⚡', '🎯'].map((emoji, i) => (
                  <div 
                    key={i}
                    className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center text-xl border-2 border-white/30"
                  >
                    {emoji}
                  </div>
                ))}
              </div>
              <span className="text-white font-medium">8 achievements to unlock!</span>
            </div>
          </div>
        </div>
      </section>
