    ...
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute top-60 right-1/3 w-1.5 h-1.5 bg-primary-400/30 rounded-full animate-float-delayed" />
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6 max-w-3xl mx-auto">
            <div className="text-center p-4 rounded-xl bg-navy-900/30 border border-navy-800/50 hover:border-primary-500/30 transition-all duration-300 hover:scale-105">
      ...
      {/* Daily Tip & Learning Streak Section */}
