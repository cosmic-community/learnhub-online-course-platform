        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="inline-flex items-center gap-2 bg-primary-500/10 border border-primary-500/20 rounded-full px-4 py-2 mb-6">
              ...
              <span className="text-sm text-primary-400 font-medium">Build your learning streak today!</span>
            </div>
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto">
            <div className="bg-navy-900/50 backdrop-blur-sm border border-navy-800 rounded-xl p-4 text-center hover:border-primary-500/30 transition-colors">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <p className="text-navy-400">Build streaks, earn achievements, and stay motivated with our gamified learning system.</p>
            </div>
            ...
            <div className="text-center p-6">
              <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-br from-purple-500/20 to-purple-600/20 flex items-center justify-center text-3xl">
                💡
              </div>
              <h3 className="text-xl font-semibold text-white mb-2">Practical Projects</h3>
              <p className="text-navy-400">Apply what you learn with hands-on code examples and real-world projects.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="card p-12 relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <p className="text-navy-300 mb-8 text-lg">
                ...
                Build your learning streak and earn achievements along the way!
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
