...
export default async function HomePage() {
  ...
  return (
    <div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary-500/10 border border-primary-500/20 rounded-full mb-6">
              ...
              <span className="text-sm text-primary-400 font-medium">New: Learning streaks & achievements!</span>
            </div>
      ...
      {/* Learning Progress & Daily Challenge */}
      <section className="py-12 bg-navy-900/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <LearningStreak />
            <DailyChallenge courses={courses} />
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-navy-300 text-lg mb-6">
                Join our community of developers, designers, and tech professionals 
                who have transformed their careers with LearnHub.
              </p>
              <div className="flex items-center gap-6">
                <div className="flex -space-x-3">
                  {['👨‍💻', '👩‍💻', '🧑‍💻', '👨‍🎨', '👩‍🎨'].map((emoji, i) => (
                    <div 
                      key={i} 
                      className="w-10 h-10 rounded-full bg-navy-700 border-2 border-navy-900 flex items-center justify-center text-lg"
                    >
                      {emoji}
                    </div>
                  ))}
                ...
                <div>
                  <div className="font-semibold text-white">10,000+ Students</div>
                  <div className="text-sm text-navy-400">learning every day</div>
                </div>
              </div>
            </div>
            <TestimonialCarousel />
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="card p-12 relative overflow-hidden">
            {/* Animated background */}
            <div className="absolute inset-0 bg-gradient-to-r from-primary-500/10 via-purple-500/10 to-pink-500/10 animate-gradient-x"></div>
            ...
            <div className="relative">
              ...
              <p className="text-navy-300 mb-8 text-lg">
                ...
                Track your progress, earn achievements, and build real-world projects.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
