  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute bottom-20 right-20 w-32 h-32 bg-blue-500/10 rounded-full blur-xl animate-float" style={{ animationDelay: '1s' }} />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6 max-w-3xl mx-auto">
            <StatItem value={`${courses.length}+`} label="Courses" icon="📚" />
            <StatItem value={`${totalLessons}+`} label="Lessons" icon="📖" />
            <StatItem value={`${instructors.length}+`} label="Instructors" icon="👨‍🏫" />
            <StatItem value={`${totalHours}+`} label="Hours" icon="⏰" />
          </div>
        </div>
      </section>

      {/* Daily Tip Section */}
      <section className="border-y border-navy-800 bg-navy-900/30">
...
// Stat item component for the hero section
function StatItem({ value, label, icon }: { value: string; label: string; icon: string }) {
  return (
    <div className="text-center group">
      <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-navy-800/50 border border-navy-700 mb-3 group-hover:scale-110 group-hover:border-primary-500/50 transition-all duration-300">
