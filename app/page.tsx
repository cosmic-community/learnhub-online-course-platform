    ...
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-20 left-10 w-2 h-2 bg-primary-500/30 rounded-full animate-float" />
          <div className="absolute top-40 right-20 w-3 h-3 bg-primary-400/20 rounded-full animate-float-delayed" />
          <div className="absolute bottom-20 left-1/4 w-2 h-2 bg-primary-600/25 rounded-full animate-float" />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <CelebrationButton href="/courses" className="btn-primary text-lg group">
            ...
            <div className="mt-6 text-navy-500 text-sm">
              Press <kbd className="px-2 py-1 bg-navy-800 rounded text-navy-300">⌘K</kbd> to quick search
            </div>
          </div>
