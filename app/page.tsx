        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32 w-full">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary-500/10 border border-primary-500/20 rounded-full text-primary-400 text-sm font-medium mb-6 animate-pulse">
              ...
              <span>{courses.length} courses available now</span>
            </div>
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8 max-w-3xl mx-auto">
            <div className="text-center">
              <AnimatedCounter value={courses.length} suffix="+" />
              <div className="text-navy-400 text-sm">Courses</div>
            </div>
            <div className="text-center">
              <AnimatedCounter value={totalLessons} suffix="+" />
              <div className="text-navy-400 text-sm">Lessons</div>
            </div>
            <div className="text-center">
              <AnimatedCounter value={instructors.length} suffix="+" />
