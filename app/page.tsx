    ...
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute bottom-32 left-1/4 w-2 h-2 bg-primary-300/30 rounded-full animate-float" />
          <div className="absolute top-1/3 right-20 w-4 h-4 bg-primary-400/10 rounded-full animate-float-slow" />
        </div>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="card p-12 relative overflow-hidden">
            ...
            <div className="absolute bottom-0 left-0 w-24 h-24 bg-primary-400/10 rounded-full blur-2xl" />
