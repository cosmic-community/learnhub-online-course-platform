...
import QuickStartLesson from '@/components/QuickStartLesson'
...
export default async function HomePage() {
  ...
  // Get a random lesson for quick start
  const randomLesson = lessons.length > 0 
    ? lessons[Math.floor(Math.random() * Math.min(lessons.length, 10))] 
    : null
  ...
  return (
    <div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="inline-flex items-center gap-2 bg-primary-500/10 border border-primary-500/20 rounded-full px-4 py-2 mb-6">
              ...
              <span className="text-primary-400 text-sm font-medium">Welcome back! Ready to learn something new?</span>
            </div>
      ...
      {/* Daily Tip & Quick Start */}
      <section className="py-12 border-b border-navy-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <DailyTip />
            {randomLesson && <QuickStartLesson lesson={randomLesson} courses={courses} />}
          </div>
        </div>
      </section>
