  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute bottom-40 right-20 w-32 h-32 bg-primary-400/10 rounded-full blur-2xl animate-pulse" style={{ animationDelay: '1s' }} />
      ...
      {/* Daily Learning Tip */}
      <section className="py-8 bg-gradient-to-r from-primary-500/5 via-primary-500/10 to-primary-500/5 border-y border-primary-500/10">
          ...
          <div className="flex items-center justify-between mb-12">
            <div>
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-primary-400 text-sm font-semibold uppercase tracking-wide">Popular Choice</span>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <div className="flex items-center justify-center gap-2 mb-2">
              <span className="text-2xl">💬</span>
              <span className="text-primary-400 text-sm font-semibold uppercase tracking-wide">Student Reviews</span>
            </div>
