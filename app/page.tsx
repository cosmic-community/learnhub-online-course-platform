...
import QuickStartRecommendation from '@/components/QuickStartRecommendation'
...
export default async function HomePage() {
  ...
  // Get beginner-friendly courses for recommendations
  const beginnerCourses = courses.filter(
    c => c.metadata?.difficulty?.value === 'Beginner' || c.metadata?.difficulty?.value === 'beginner'
  ).slice(0, 3)
  ...
  return (
    <div>
      ...
      {beginnerCourses.length > 0 && (
        <QuickStartRecommendation courses={beginnerCourses} />
      )}
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="card p-12 relative overflow-hidden group">
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-primary-500/10 via-primary-600/5 to-primary-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
