...
export default async function HomePage() {
  ...
  // Calculate total lessons and learning hours
  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          ...
          <div className="mt-16 grid grid-cols-2 lg:grid-cols-4 gap-6 max-w-3xl mx-auto">
            <div className="text-center p-4 bg-navy-900/50 rounded-xl border border-navy-800">
      ...
      {/* Gamification Banner */}
      <section className="py-12 bg-gradient-to-r from-orange-500/10 via-red-500/10 to-pink-500/10 border-y border-orange-500/20">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-navy-300">Learn daily and watch your streak grow. Stay consistent to unlock achievements!</p>
              </div>
            </div>
            <div className="flex items-center gap-6">
              <div className="flex items-center gap-2 text-sm">
                <span className="text-2xl">🌱</span>
                <span className="text-navy-300">1-2 days</span>
              </div>
              <div className="flex items-center gap-2 text-sm">
                <span className="text-2xl">✨</span>
                <span className="text-navy-300">3-6 days</span>
              </div>
              <div className="flex items-center gap-2 text-sm">
                <span className="text-2xl">🔥</span>
                <span className="text-navy-300">7+ days</span>
              </div>
              <div className="flex items-center gap-2 text-sm">
                <span className="text-2xl">🏆</span>
                <span className="text-navy-300">30+ days</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="card p-12">
            ...
            <p className="text-navy-300 mb-8 text-lg">
              ...
              Complete lessons, build your streak, and celebrate your progress!
            </p>
            <Link href="/courses" className="btn-primary text-lg">
              Get Started Now
            </Link>
