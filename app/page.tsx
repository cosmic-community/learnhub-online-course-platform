    ...
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute top-40 right-20 text-3xl animate-float-medium opacity-20">💻</div>
          <div className="absolute bottom-40 left-1/4 text-3xl animate-float-fast opacity-20">🎯</div>
          <div className="absolute bottom-20 right-1/3 text-4xl animate-float-slow opacity-20">🚀</div>
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6 max-w-3xl mx-auto">
            <div className="text-center group">
              <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-primary-500/10 mb-3 group-hover:scale-110 transition-transform">
          ...
          <div className="flex items-center justify-between mb-12">
            <div>
              <div className="flex items-center gap-2 mb-2">
                <span className="text-2xl">⭐</span>
                <span className="text-primary-400 font-semibold text-sm uppercase tracking-wider">Featured</span>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="card p-6 text-center group hover:border-primary-500/50">
              <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-br from-primary-500/20 to-primary-600/20 flex items-center justify-center group-hover:scale-110 transition-transform">
                <span className="text-3xl">🎯</span>
              </div>
              <h3 className="text-xl font-semibold text-white mb-2">Learn by Doing</h3>
              <p className="text-navy-400">Hands-on projects and real-world examples to solidify your knowledge</p>
            </div>
            <div className="card p-6 text-center group hover:border-primary-500/50">
              <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-br from-primary-500/20 to-primary-600/20 flex items-center justify-center group-hover:scale-110 transition-transform">
                <span className="text-3xl">🏆</span>
              ...
              <p className="text-navy-400">Earn achievements and maintain streaks to stay motivated</p>
            </div>
            <div className="card p-6 text-center group hover:border-primary-500/50">
              <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-br from-primary-500/20 to-primary-600/20 flex items-center justify-center group-hover:scale-110 transition-transform">
                <span className="text-3xl">👨‍🏫</span>
