        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6 max-w-3xl mx-auto animate-fade-in-up animation-delay-400">
            <div className="stat-card">
              ...
              <div className="text-3xl font-bold text-white counter">{courses.length}</div>
              <div className="text-navy-400 text-sm">Courses</div>
            </div>
            <div className="stat-card">
              <div className="stat-icon">👨‍🏫</div>
              <div className="text-3xl font-bold text-white counter">{instructors.length}</div>
              <div className="text-navy-400 text-sm">Instructors</div>
            </div>
            <div className="stat-card">
              <div className="stat-icon">⏱️</div>
              <div className="text-3xl font-bold text-white counter">{totalHours}+</div>
              <div className="text-navy-400 text-sm">Hours of Content</div>
            </div>
            <div className="stat-card">
              <div className="stat-icon">📖</div>
              <div className="text-3xl font-bold text-white counter">{totalLessons}</div>
      ...
      <section className="py-16 bg-gradient-to-b from-navy-900/50 to-transparent">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <h2 className="text-2xl font-bold text-white mb-2">Skills You&apos;ll Master</h2>
            <p className="text-navy-400">Technologies covered across our courses</p>
          </div>
          <SkillShowcase categories={categories} />
        </div>
      </section>
