          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6 max-w-3xl mx-auto">
            <div className="text-center group hover-lift">
              <div className="text-3xl font-bold text-white flex items-center justify-center gap-1">
                <AnimatedCounter end={courses.length} suffix="+" className="tabular-nums" />
              </div>
              <div className="text-navy-400 text-sm">Courses</div>
            </div>
            <div className="text-center group hover-lift">
              <div className="text-3xl font-bold text-white">
                <AnimatedCounter end={totalLessons} suffix="+" className="tabular-nums" />
              </div>
              <div className="text-navy-400 text-sm">Lessons</div>
            </div>
            <div className="text-center group hover-lift">
              <div className="text-3xl font-bold text-white">
                <AnimatedCounter end={totalHours} suffix="h" className="tabular-nums" />
              </div>
              <div className="text-navy-400 text-sm">Content</div>
            </div>
            <div className="text-center group hover-lift">
              <div className="text-3xl font-bold text-white">
                <AnimatedCounter end={instructors.length} suffix="+" className="tabular-nums" />
              </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="card p-12 relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <Link href="/courses" className="btn-primary text-lg animate-glow">
                Get Started Now
              </Link>
            </div>
          </div>
