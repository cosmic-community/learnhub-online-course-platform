...
export default async function HomePage() {
  ...
  return (
    <div>
      {/* Confetti celebration for returning visitors */}
      <ConfettiCelebration />
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute top-40 right-20 w-32 h-32 bg-primary-400/10 rounded-full blur-2xl animate-float-delayed" />
        <div className="absolute bottom-20 left-1/4 w-16 h-16 bg-primary-600/10 rounded-full blur-lg animate-float-slow" />
      ...
      <section className="py-8 bg-gradient-to-r from-primary-500/10 via-primary-400/5 to-primary-500/10">
