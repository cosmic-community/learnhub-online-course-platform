    ...
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute top-1/3 right-1/4 w-3 h-3 bg-primary-500/20 rounded-full animate-ping" style={{ animationDuration: '3s' }} />
          <div className="absolute bottom-1/4 left-1/3 w-2 h-2 bg-primary-400/25 rounded-full animate-pulse" style={{ animationDelay: '1s' }} />
          <div className="absolute top-1/2 right-1/3 w-2 h-2 bg-primary-500/30 rounded-full animate-ping" style={{ animationDuration: '4s' }} />
        </div>
