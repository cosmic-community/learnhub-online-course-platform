    ...
    <div>
      ...
      <section className="py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="card p-8 bg-gradient-to-r from-orange-500/10 to-amber-500/10 border-orange-500/20">
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 rounded-full bg-orange-500/20 flex items-center justify-center text-2xl flex-shrink-0">
                💡
              </div>
              <div>
                <h3 className="text-lg font-semibold text-white mb-2">Daily Learning Tip</h3>
                <p className="text-navy-300">
                  Consistency beats intensity! Studies show that learning for just 20 minutes daily leads to better retention than cramming for hours. 
                  Keep your streak alive and watch your skills grow!
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="card p-12">
            ...
            <p className="text-navy-300 mb-8 text-lg">
              ...
              Build your streak, track your progress, and achieve your goals!
            </p>
            <Link href="/courses" className="btn-primary text-lg">
              Get Started Now
            </Link>
