...
import LearningStatsBar from '@/components/LearningStatsBar'
  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-primary-500/10 text-primary-400 px-4 py-2 rounded-full text-sm font-medium mb-6 animate-pulse">
      ...
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="card p-8 bg-gradient-to-r from-primary-500/10 to-navy-900/50 border-primary-500/20">
            <div className="flex flex-col md:flex-row items-center gap-6">
              <div className="text-6xl">💡</div>
              <div className="flex-1 text-center md:text-left">
                <h3 className="text-xl font-semibold text-white mb-2">Daily Learning Tip</h3>
                <p className="text-navy-300">
                  Studies show that learning for just 20 minutes a day can lead to mastery over time. 
      ...
      <section className="py-20 bg-navy-900/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-12">
            ...
            <Link href="/instructors" className="btn-secondary hidden sm:inline-flex">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-navy-400">Join thousands of learners already advancing their careers</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="card p-6 text-center">
              ...
              <h3 className="text-lg font-semibold text-white mb-2">Project-Based Learning</h3>
              <p className="text-navy-400 text-sm">
                Learn by doing with hands-on projects that reinforce concepts and build your portfolio.
              </p>
            </div>
            <div className="card p-6 text-center">
              <div className="w-16 h-16 bg-primary-500/20 rounded-2xl flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-navy-400 text-sm">
                Learn from professionals with years of industry experience at top companies.
              </p>
            </div>
            <div className="card p-6 text-center">
              <div className="w-16 h-16 bg-primary-500/20 rounded-2xl flex items-center justify-center mx-auto mb-4">
