...
export default async function HomePage() {
  ...
  // Calculate total learning content
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary-500/10 border border-primary-500/20 rounded-full text-primary-400 text-sm font-medium mb-6">
              ...
              {lessons.length}+ lessons • {totalHours}+ hours of content
            </div>
          ...
          <div className="mt-16 grid grid-cols-2 sm:grid-cols-4 gap-8 max-w-3xl mx-auto">
            ...
            <div className="text-center group">
              <div className="text-3xl font-bold text-white group-hover:text-primary-400 transition-colors">{lessons.length}+</div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="card p-8 text-center card-interactive">
              <div className="w-16 h-16 bg-gradient-to-br from-blue-500/20 to-cyan-500/20 rounded-2xl flex items-center justify-center mx-auto mb-6 border border-blue-500/30">
                <span className="text-3xl">🎯</span>
              </div>
              <h3 className="text-xl font-semibold text-white mb-3">Expert-Led Content</h3>
            ...
            <div className="card p-8 text-center card-interactive">
              ...
              <p className="text-navy-400">Practice with real code examples and build projects as you learn.</p>
            </div>
            ...
            <div className="card p-8 text-center card-interactive">
              ...
              <p className="text-navy-400">Monitor your learning journey with streaks, achievements, and progress tracking.</p>
            </div>
          </div>
        </div>
      </section>
