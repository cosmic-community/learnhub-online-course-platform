    ...
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-20 left-10 w-4 h-4 bg-primary-400/30 rounded-full animate-pulse" />
          <div className="absolute top-40 right-20 w-6 h-6 bg-primary-500/20 rounded-full animate-bounce" style={{ animationDelay: '0.5s' }} />
          <div className="absolute bottom-40 left-1/4 w-3 h-3 bg-cyan-400/30 rounded-full animate-pulse" style={{ animationDelay: '1s' }} />
          <div className="absolute top-1/3 right-1/4 w-5 h-5 bg-primary-400/25 rounded-full animate-bounce" style={{ animationDelay: '0.3s' }} />
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="inline-flex items-center gap-2 bg-primary-500/10 border border-primary-500/30 rounded-full px-4 py-2 mb-6">
              ...
              <span className="text-primary-300 text-sm font-medium">Start learning today — track your progress!</span>
            </div>
      ...
      <section className="py-16 bg-gradient-to-r from-primary-500/10 via-navy-900 to-primary-600/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <span className="text-4xl mb-4 block">🎯</span>
            <h2 className="text-2xl font-bold text-white mb-3">Track Your Learning Journey</h2>
            <p className="text-navy-300 max-w-2xl mx-auto">
              Click the 🔥 button in the corner to see your streak, unlock achievements, and track your progress as you explore courses!
            </p>
          </div>
        </div>
      </section>
