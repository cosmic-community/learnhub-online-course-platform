    ...
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute bottom-1/4 left-1/3 w-2 h-2 bg-primary-300/25 rounded-full animate-float" />
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          ...
          <div className="mt-16">
            <AnimatedStats 
              stats={[
                { value: courses.length, label: 'Courses', suffix: '+' },
                { value: totalLessons, label: 'Lessons', suffix: '+' },
                { value: instructors.length, label: 'Instructors', suffix: '+' },
              ]}
            />
          </div>
        </div>
      ...
      <section className="py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="card p-8">
            <QuickStartRecommendation courses={courses} />
          </div>
        </div>
      </section>
