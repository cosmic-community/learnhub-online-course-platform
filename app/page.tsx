    ...
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute bottom-20 left-1/4 w-24 h-24 bg-amber-500/10 rounded-full blur-xl animate-pulse delay-500" />
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          ...
          <div className="mt-16 grid grid-cols-2 sm:grid-cols-4 gap-6 max-w-3xl mx-auto">
            ...
            <div className="text-center group">
              <div className="inline-flex items-center justify-center w-12 h-12 bg-orange-500/10 rounded-xl mb-3 group-hover:scale-110 transition-transform">
                <span className="text-2xl">🎓</span>
              </div>
            ...
            <div className="text-center group">
              <div className="inline-flex items-center justify-center w-12 h-12 bg-green-500/10 rounded-xl mb-3 group-hover:scale-110 transition-transform">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="card p-6 text-center group hover:border-primary-500/50">
              ...
              <h3 className="text-xl font-semibold text-white mb-2">Practical Projects</h3>
              <p className="text-navy-400">Build real-world projects that you can add to your portfolio</p>
            </div>
            
            <div className="card p-6 text-center group hover:border-orange-500/50">
              <div className="w-16 h-16 mx-auto mb-4 bg-gradient-to-br from-orange-500/20 to-amber-500/20 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform">
                <span className="text-3xl">🔥</span>
              </div>
              <h3 className="text-xl font-semibold text-white mb-2">Daily Streaks</h3>
              <p className="text-navy-400">Stay motivated with our learning streak tracker and achievements</p>
            </div>
            
            <div className="card p-6 text-center group hover:border-green-500/50">
              <div className="w-16 h-16 mx-auto mb-4 bg-gradient-to-br from-green-500/20 to-emerald-500/20 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform">
                <span className="text-3xl">💬</span>
              </div>
              <h3 className="text-xl font-semibold text-white mb-2">Expert Support</h3>
              <p className="text-navy-400">Get help from instructors and a supportive community</p>
            </div>
          </div>
        </div>
      </section>
