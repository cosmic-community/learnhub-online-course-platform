...
import LearningStreakBanner from '@/components/LearningStreakBanner'
...
export default async function HomePage() {
  ...
  return (
    <div>
      ...
      {/* Hero Section with Floating Code */}
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight animate-slide-up">
              Learn skills that
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-400 to-purple-400"> advance your career</span>
            </h1>
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto animate-fade-in animation-delay-300">
            <div className="text-center p-6 rounded-2xl bg-navy-900/50 border border-navy-800 hover:border-primary-500/30 transition-colors group">
              <div className="w-12 h-12 mx-auto mb-3 rounded-xl bg-primary-500/20 flex items-center justify-center group-hover:scale-110 transition-transform">
            ...
            <div className="text-center p-6 rounded-2xl bg-navy-900/50 border border-navy-800 hover:border-purple-500/30 transition-colors group">
            ...
            <div className="text-center p-6 rounded-2xl bg-navy-900/50 border border-navy-800 hover:border-green-500/30 transition-colors group">
            ...
            <div className="text-center p-6 rounded-2xl bg-navy-900/50 border border-navy-800 hover:border-yellow-500/30 transition-colors group">
              <div className="w-12 h-12 mx-auto mb-3 rounded-xl bg-yellow-500/20 flex items-center justify-center group-hover:scale-110 transition-transform">
          ...
          <div className="flex items-center justify-between mb-12">
            <div>
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-primary-400 text-sm font-medium uppercase tracking-wider">Trending</span>
              </div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <div className="flex items-center justify-center gap-2 mb-2">
              <span className="text-2xl">👨‍🏫</span>
              <span className="text-primary-400 text-sm font-medium uppercase tracking-wider">Instructors</span>
            </div>
