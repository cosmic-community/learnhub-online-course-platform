      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          ...
          <div className="mt-16 max-w-2xl mx-auto">
            <LearningDashboard courses={courses} totalLessons={lessons.length} />
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="card p-6 text-center group hover:bg-navy-800/50 transition-colors">
              <div className="inline-flex items-center justify-center w-14 h-14 bg-primary-500/10 rounded-xl mb-4 group-hover:scale-110 transition-transform">
                <span className="text-3xl">🎯</span>
              </div>
              <h3 className="text-lg font-semibold text-white mb-2">Project-Based Learning</h3>
              <p className="text-navy-400 text-sm">Build real projects and add them to your portfolio</p>
            </div>
            
            <div className="card p-6 text-center group hover:bg-navy-800/50 transition-colors">
              <div className="inline-flex items-center justify-center w-14 h-14 bg-green-500/10 rounded-xl mb-4 group-hover:scale-110 transition-transform">
                <span className="text-3xl">👨‍🏫</span>
              </div>
              <h3 className="text-lg font-semibold text-white mb-2">Expert Instructors</h3>
              <p className="text-navy-400 text-sm">Learn from professionals with years of experience</p>
            </div>
            
            <div className="card p-6 text-center group hover:bg-navy-800/50 transition-colors">
              <div className="inline-flex items-center justify-center w-14 h-14 bg-yellow-500/10 rounded-xl mb-4 group-hover:scale-110 transition-transform">
                <span className="text-3xl">⏰</span>
              </div>
            ...
            <div className="card p-6 text-center group hover:bg-navy-800/50 transition-colors">
              <div className="inline-flex items-center justify-center w-14 h-14 bg-purple-500/10 rounded-xl mb-4 group-hover:scale-110 transition-transform">
                <span className="text-3xl">🏆</span>
              </div>
              <h3 className="text-lg font-semibold text-white mb-2">Track Your Progress</h3>
              <p className="text-navy-400 text-sm">Daily streaks and achievements to keep you motivated</p>
            </div>
          </div>
        </div>
      </section>
