...
export default async function HomePage() {
  ...
  return (
    <div>
      ...
      <section id="quiz" className="py-20 bg-gradient-to-b from-navy-950 to-navy-900/50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <span className="inline-block text-4xl mb-4 animate-bounce-slow">🎯</span>
            <h2 className="text-3xl font-bold text-white mb-2">Not Sure Where to Start?</h2>
            <p className="text-navy-400">Answer a few questions and we'll recommend the perfect course for you</p>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="card p-12 relative overflow-hidden group">
            ...
            <div className="relative">
              <span className="inline-block text-5xl mb-4 animate-bounce-slow">🚀</span>
