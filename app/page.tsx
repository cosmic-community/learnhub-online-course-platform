    ...
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute top-40 right-20 w-6 h-6 bg-primary-500/15 rounded-full animate-float-delayed" />
          <div className="absolute bottom-40 left-1/4 w-3 h-3 bg-primary-300/25 rounded-full animate-float" />
          <div className="absolute top-60 right-1/3 w-5 h-5 bg-primary-400/10 rounded-full animate-float-delayed" />
        </div>
      ...
      <section className="py-20 bg-gradient-to-b from-navy-950 to-navy-900/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-navy-400">Tell us about yourself and we&apos;ll recommend the perfect courses for you</p>
          </div>
          <LearningPathRecommender courses={courses} categories={categories} />
        </div>
      </section>
