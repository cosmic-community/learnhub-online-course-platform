    ...
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute bottom-40 left-1/4 w-2 h-2 bg-orange-400/30 rounded-full animate-float" />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="inline-flex items-center gap-2 bg-primary-500/10 border border-primary-500/20 rounded-full px-4 py-2 mb-6 text-primary-300 text-sm">
              <span className="animate-pulse">🎯</span>
              <span>Track your progress with our new learning streak feature!</span>
            </div>
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 max-w-3xl mx-auto">
            <div className="text-center p-4 rounded-2xl bg-navy-900/30 border border-navy-800 hover:border-primary-500/30 transition-colors">
      ...
      <section className="py-16 bg-gradient-to-r from-primary-500/10 to-orange-500/10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="card p-8 text-center bg-navy-900/70 backdrop-blur-xl border-primary-500/20">
            <div className="text-4xl mb-4">💡</div>
            <h3 className="text-xl font-bold text-white mb-2">Daily Learning Tip</h3>
            <p className="text-navy-300 text-lg">
              &ldquo;Consistency beats intensity. Learning just 20 minutes a day builds stronger habits than 
              marathon study sessions once a week.&rdquo;
            </p>
            <div className="mt-4 text-sm text-primary-400">
              Build your streak by visiting daily! 🔥
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="card p-12 relative overflow-hidden">
            ...
            <div className="absolute bottom-0 right-0 w-40 h-40 bg-orange-500/10 rounded-full translate-x-1/2 translate-y-1/2" />
            ...
            <div className="relative">
              ...
              <p className="text-navy-300 mb-8 text-lg">
                ...
                Build your learning streak and unlock achievements along the way! 🏆
              </p>
