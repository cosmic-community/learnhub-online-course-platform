  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute bottom-20 right-10 w-32 h-32 bg-primary-500/5 rounded-full blur-3xl animate-float-delayed" />
        
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary-500/10 rounded-full text-primary-400 text-sm font-medium mb-6 animate-fadeIn">
            ...
            <p className="text-xl text-navy-300 mb-8 animate-slideUp animation-delay-100">
            ...
            <p className="hidden md:block mt-6 text-navy-500 text-sm animate-fadeIn animation-delay-300">
              Press <kbd className="px-2 py-1 bg-navy-800 rounded text-navy-300 mx-1">⌘</kbd> + <kbd className="px-2 py-1 bg-navy-800 rounded text-navy-300 mx-1">K</kbd> to search
            </p>
          </div>
          
          {/* Stats */}
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8 max-w-3xl mx-auto animate-slideUp animation-delay-300">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {featuredCourses.map((course, index) => (
              <div key={course.id} className="animate-slideUp" style={{ animationDelay: `${index * 100}ms` }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {categories.map((category, index) => (
              <div key={category.id} className="animate-slideUp" style={{ animationDelay: `${index * 50}ms` }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {instructors.map((instructor, index) => (
              <div key={instructor.id} className="animate-slideUp" style={{ animationDelay: `${index * 100}ms` }}>
          ...
          <div className="card p-12 relative overflow-hidden group">
            ...
            <div className="relative">
              ...
              <Link href="/courses" className="btn-primary text-lg group/btn">
                Get Started Now
                <svg className="w-5 h-5 ml-2 inline-block transform transition-transform group-hover/btn:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
