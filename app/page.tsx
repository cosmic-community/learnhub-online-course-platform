...
export default async function HomePage() {
  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center max-w-3xl mx-auto">
            {/* Streak badge teaser */}
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-orange-500/10 border border-orange-500/20 rounded-full text-orange-400 text-sm font-medium mb-6 animate-pulse-slow">
              <span>🔥</span>
              <span>Track your learning streak!</span>
            </div>
      ...
      <section className="py-16 bg-gradient-to-r from-primary-500/10 via-navy-900/50 to-orange-500/10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-primary-500/20 rounded-2xl mb-6">
            <span className="text-3xl">🎯</span>
          </div>
          <h2 className="text-2xl font-bold text-white mb-4">Build Your Learning Streak</h2>
          <p className="text-navy-300 mb-6 max-w-2xl mx-auto">
            Consistency is key to mastering new skills. Visit daily to build your streak and unlock achievements. 
            Track your progress with our gamified learning system!
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <div className="flex items-center gap-2 px-4 py-2 bg-navy-800/50 rounded-full text-sm">
              <span>🔥</span>
              <span className="text-navy-300">Daily streaks</span>
            </div>
            <div className="flex items-center gap-2 px-4 py-2 bg-navy-800/50 rounded-full text-sm">
              <span>🏆</span>
              <span className="text-navy-300">Milestone rewards</span>
            </div>
            <div className="flex items-center gap-2 px-4 py-2 bg-navy-800/50 rounded-full text-sm">
              <span>📈</span>
              <span className="text-navy-300">Progress tracking</span>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="card p-12 relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <p className="text-navy-300 mb-8 text-lg">
                ...
                Build your streak. Achieve your goals.
              </p>
