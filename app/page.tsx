  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute bottom-20 left-1/4 text-3xl opacity-20 animate-float" style={{ animationDelay: '2s' }}>🎯</div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
              Learn skills that
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-400 to-yellow-400 animate-gradient"> advance your career</span>
            </h1>
      ...
      {/* Learning Streak + Featured Courses */}
      <section className="py-12 bg-navy-900/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            {/* Learning Streak Sidebar */}
