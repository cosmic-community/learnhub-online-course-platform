    ...
    <div>
          ...
          <div className="flex items-center justify-between mb-12">
            <div>
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-primary-400 font-semibold text-sm uppercase tracking-wide">Trending</span>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="card p-8 text-center group hover:border-primary-500/50">
              <div className="w-16 h-16 bg-primary-500/10 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform">
            ...
            <div className="card p-8 text-center group hover:border-primary-500/50">
              ...
              <p className="text-navy-400">
                Access courses on any device, anytime, and learn at your own pace
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-navy-900/30">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="card p-12 bg-gradient-to-br from-navy-900 to-navy-900/50 border-primary-500/20">
            ...
            <p className="text-navy-300 mb-8 text-lg max-w-2xl mx-auto">
              ...
              Track your progress, earn streaks, and level up your career!
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
