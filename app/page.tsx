...
export default async function HomePage() {
  ...
  return (
    <div>
      {/* Confetti Celebration for returning users */}
      <ConfettiCelebration />
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute bottom-20 left-1/4 text-3xl opacity-20 animate-float" style={{ animationDelay: '0.5s' }}>🚀</div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6 max-w-3xl mx-auto">
            <div className="text-center p-4 rounded-xl bg-navy-900/30 border border-navy-800 hover:border-primary-500/50 transition-colors">
