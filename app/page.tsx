  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute top-20 left-10 w-3 h-3 bg-primary-400/30 rounded-full animate-float" />
        <div className="absolute top-40 right-20 w-2 h-2 bg-primary-500/40 rounded-full animate-float-delayed" />
        <div className="absolute bottom-32 left-1/4 w-4 h-4 bg-primary-300/20 rounded-full animate-float-slow" />
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="card p-12 relative overflow-hidden group">
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-primary-500/5 via-primary-400/10 to-primary-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
