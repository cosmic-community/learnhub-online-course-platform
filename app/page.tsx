    ...
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute top-40 right-[15%] w-3 h-3 bg-primary-400/20 rounded-full animate-float-delayed" />
          <div className="absolute bottom-40 left-[20%] w-2 h-2 bg-primary-400/25 rounded-full animate-float" />
          <div className="absolute top-60 right-[25%] w-1.5 h-1.5 bg-primary-400/30 rounded-full animate-float-delayed" />
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-xl text-navy-300 mb-8 animate-fade-in-delayed">
