...
import LearningTipsCarousel from '@/components/LearningTipsCarousel'
    ...
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute bottom-32 left-1/4 w-2 h-2 bg-primary-400/25 rounded-full animate-float" />
          <div className="absolute top-1/3 right-1/3 w-4 h-4 bg-primary-500/15 rounded-full animate-float-slow" />
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          ...
          <div className="mt-16 grid grid-cols-2 sm:grid-cols-4 gap-6 max-w-3xl mx-auto">
            ...
            <div className="text-center group">
              ...
              <div className="text-navy-400 text-sm group-hover:text-primary-400 transition-colors">Lessons</div>
            </div>
            <div className="text-center group">
              <div className="text-3xl font-bold text-white mb-1">
                <AnimatedCounter end={instructors.length} suffix="+" />
              </div>
              <div className="text-navy-400 text-sm group-hover:text-primary-400 transition-colors">Instructors</div>
            </div>
            <div className="text-center group">
              <div className="text-3xl font-bold text-white mb-1">
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="card p-12 relative overflow-hidden">
            ...
            <div className="absolute bottom-0 left-0 w-48 h-48 bg-gradient-to-tr from-primary-500/5 to-transparent rounded-full blur-2xl" />
