    ...
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute bottom-32 left-1/4 text-3xl animate-float opacity-20">🎯</div>
          <div className="absolute bottom-20 right-1/3 text-4xl animate-float-delayed opacity-20">✨</div>
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-slideUp animation-delay-200">
              <LearningPathFinder courses={courses} categories={categories} />
      ...
      <section className="py-20 bg-navy-900/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-navy-400">Everything you need for a great learning experience</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="card p-6 text-center group hover:border-primary-500/50 transition-all">
              <div className="w-16 h-16 mx-auto mb-4 bg-primary-500/10 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform">
            ...
            <div className="card p-6 text-center group hover:border-primary-500/50 transition-all">
              ...
              <p className="text-navy-400">Practical skills that help you advance in your career</p>
            </div>
          </div>
        </div>
      </section>
