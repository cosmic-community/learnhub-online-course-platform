...
export default async function HomePage() {
  ...
  return (
    <div>
      ...
      <section className="py-16 bg-gradient-to-r from-primary-500/10 via-primary-500/5 to-transparent">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center gap-8 p-8 bg-navy-900/50 backdrop-blur-sm border border-navy-800 rounded-3xl">
            <div className="flex-shrink-0">
              <div className="w-20 h-20 bg-gradient-to-br from-primary-500 to-primary-600 rounded-2xl flex items-center justify-center text-4xl shadow-lg shadow-primary-500/25">
                🎯
              </div>
            </div>
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-navy-300">
                Explore our curated categories to find the perfect learning path for your goals. 
