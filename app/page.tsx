  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute bottom-20 left-20 text-3xl animate-float opacity-20">🚀</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="card p-6 text-center group hover:border-primary-500/50">
              ...
              <p className="text-navy-400 text-sm">Build streaks, earn achievements, and watch yourself grow</p>
            </div>
            <div className="card p-6 text-center group hover:border-primary-500/50">
              <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-green-500/10 flex items-center justify-center text-3xl group-hover:scale-110 transition-transform">
                👨‍🏫
              </div>
