          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="feature-card text-center">
                ...
                <p className="text-navy-400 text-sm">Build real projects while you learn</p>
              </div>
              <div className="feature-card text-center">
                <div className="feature-icon">💡</div>
                <h3 className="text-lg font-semibold text-white mb-2">Expert Instructors</h3>
                <p className="text-navy-400 text-sm">Learn from industry professionals</p>
              </div>
              <div className="feature-card text-center">
                <div className="feature-icon">🚀</div>
                <h3 className="text-lg font-semibold text-white mb-2">Self-Paced Learning</h3>
                <p className="text-navy-400 text-sm">Learn at your own speed</p>
              </div>
              <div className="feature-card text-center">
                <div className="feature-icon">🏆</div>
                <h3 className="text-lg font-semibold text-white mb-2">Certificates</h3>
                <p className="text-navy-400 text-sm">Earn certificates upon completion</p>
              </div>
            </div>
          </div>
        </section>
