  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute bottom-20 right-20 w-32 h-32 bg-primary-400/10 rounded-full blur-2xl animate-float-delayed" />
        ...
        <section className="py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center gap-3 mb-8">
              ...
              <div>
                <h2 className="text-2xl font-bold text-white">Perfect for Beginners</h2>
                <p className="text-navy-400">Start from scratch with these beginner-friendly courses</p>
              </div>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {beginnerCourses.slice(0, 3).map((course, index) => (
                <div key={course.id} className="animate-fade-in" style={{ animationDelay: `${index * 100}ms` }}>
                  <CourseCard course={course} />
                </div>
              ))}
      ...
      {freeCourses.length > 0 && (
        <section className="py-20 bg-gradient-to-r from-primary-500/10 via-navy-900/50 to-primary-500/10">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-2 bg-primary-500/20 rounded-full px-4 py-2 mb-4">
                <span className="text-2xl">🎁</span>
                <span className="text-primary-400 font-semibold">FREE</span>
              </div>
              <h2 className="text-3xl font-bold text-white mb-2">Start Learning for Free</h2>
              <p className="text-navy-400">Get started with our free courses - no credit card required</p>
            </div>
