...
export default async function HomePage() {
  ...
  // Calculate total lesson count for stats
  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8 max-w-3xl mx-auto">
            <div className="text-center group animate-fade-in animation-delay-400">
              <div className="text-3xl font-bold text-white group-hover:text-primary-400 transition-colors counter" data-target={courses.length}>
                {courses.length}+
              </div>
            ...
            <div className="text-center group animate-fade-in animation-delay-600">
              <div className="text-3xl font-bold text-white group-hover:text-primary-400 transition-colors">
                {totalHours}+
              </div>
              <div className="text-navy-400 text-sm">Hours of Content</div>
            </div>
            <div className="text-center group animate-fade-in animation-delay-700">
              <div className="text-3xl font-bold text-white group-hover:text-primary-400 transition-colors">
                {instructors.length}+
              </div>
      ...
      <QuickStartButton courses={courses} />
    </div>
  )
}