  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6 max-w-3xl mx-auto">
            <div className="text-center p-4 bg-navy-900/30 rounded-xl border border-navy-800/50">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-br from-primary-500/10 to-navy-900/50 rounded-3xl border border-primary-500/20 p-8 md:p-12">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <div className="inline-flex items-center gap-2 bg-primary-500/20 rounded-full px-3 py-1 text-primary-400 text-sm font-medium mb-4">
                  ✨ Track Your Progress
                </div>
                ...
                <p className="text-navy-300 mb-6">
                  Stay motivated with our gamified learning system. Set weekly goals, 
                  maintain your streak, and celebrate your achievements with confetti! 🎉
                </p>
              ...
              <div className="hidden md:flex justify-center">
                <div className="relative">
                  <div className="w-64 h-64 bg-gradient-to-br from-primary-500/20 to-transparent rounded-full flex items-center justify-center">
                    <div className="text-8xl animate-bounce">🔥</div>
                  </div>
                  <div className="absolute -top-4 -right-4 bg-yellow-400 text-yellow-900 font-bold text-lg px-4 py-2 rounded-full">
                    7 day streak!
                  </div>
                </div>
              </div>
