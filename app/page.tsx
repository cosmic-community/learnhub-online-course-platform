        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="card p-8 text-center">
              ...
              <p className="text-navy-400">Learn from industry professionals who have real-world experience in their fields.</p>
            </div>
            ...
            <div className="card p-8 text-center">
              ...
              <p className="text-navy-400">Keep your learning streak alive and watch your knowledge grow day by day.</p>
            </div>
            ...
            <div className="card p-8 text-center">
              ...
              <p className="text-navy-400">Access courses anytime, anywhere. Learn on your schedule without pressure.</p>
            </div>
          </div>
        </div>
      </section>
