...
import SkillPathVisual from '@/components/SkillPathVisual'
...
export default async function HomePage() {
  ...
  // Create skill paths based on difficulty progression
  ...
  return (
    <div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-primary-500/10 border border-primary-500/20 rounded-full px-4 py-2 mb-6 animate-fade-in">
              ...
              <span className="text-primary-300 text-sm font-medium">{courses.length} courses available</span>
            </div>
            ...
            <p className="text-xl text-navy-300 mb-8 animate-slide-up-delay">
          ...
          <div className="mt-16 grid grid-cols-3 gap-8 max-w-2xl mx-auto">
            <div className="text-center group">
              <div className="text-3xl font-bold text-white group-hover:text-primary-400 transition-colors counter-animate">
                {courses.length}+
              </div>
      ...
      {/* Skill Path Section - NEW! */}
      <section className="py-20 bg-gradient-to-b from-navy-900/50 to-transparent">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <span className="inline-block px-4 py-1 bg-primary-500/10 border border-primary-500/20 rounded-full text-primary-400 text-sm font-medium mb-4">
              ✨ Your Learning Journey
            </span>
            <h2 className="text-3xl font-bold text-white mb-2">Choose Your Skill Path</h2>
            <p className="text-navy-400">Progress from beginner to expert with our structured learning paths</p>
          </div>
