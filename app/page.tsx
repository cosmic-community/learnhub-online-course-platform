  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute top-40 right-20 text-3xl animate-bounce-slow animation-delay-1000 opacity-20">💻</div>
        <div className="absolute bottom-20 left-1/4 text-3xl animate-bounce-slow animation-delay-2000 opacity-20">🎯</div>
