...
export default async function HomePage() {
  ...
  // Calculate total learning content stats
  ...
  return (
    <div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-primary-500/10 border border-primary-500/20 rounded-full px-4 py-2 mb-6">
              ...
              <span className="text-primary-400 text-sm font-medium">{totalLessons}+ lessons available</span>
            </div>
      ...
      <section className="py-12 bg-navy-900/30 border-y border-navy-800">
      ...
      <section className="py-20 bg-navy-900/30">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="card p-12 relative overflow-hidden">
            {/* Decorative elements */}
            <div className="absolute top-4 left-4 text-4xl opacity-20 animate-bounce" style={{ animationDelay: '0s' }}>🎓</div>
            <div className="absolute top-4 right-4 text-4xl opacity-20 animate-bounce" style={{ animationDelay: '0.2s' }}>📚</div>
            <div className="absolute bottom-4 left-4 text-4xl opacity-20 animate-bounce" style={{ animationDelay: '0.4s' }}>💡</div>
            <div className="absolute bottom-4 right-4 text-4xl opacity-20 animate-bounce" style={{ animationDelay: '0.6s' }}>🚀</div>
