...
export default async function HomePage() {
  ...
  return (
    <div>
      ...
      {/* Gamification Section - Learning Streak & Achievements */}
      ...
      <section className="py-20 bg-navy-900/30">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="card p-12 relative overflow-hidden">
            {/* Decorative elements */}
            <div className="absolute top-0 left-0 w-32 h-32 bg-primary-500/10 rounded-br-full" />
            <div className="absolute bottom-0 right-0 w-32 h-32 bg-primary-500/10 rounded-tl-full" />
