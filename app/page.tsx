    ...
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute top-40 right-20 w-3 h-3 bg-primary-500/20 rounded-full animate-pulse delay-300" />
          <div className="absolute bottom-40 left-1/4 w-2 h-2 bg-primary-300/25 rounded-full animate-pulse delay-500" />
          <div className="absolute top-60 right-1/3 w-2 h-2 bg-primary-400/30 rounded-full animate-pulse delay-700" />
        </div>
      ...
      <section className="py-16 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          ...
          <p className="text-navy-300 mb-6 max-w-2xl mx-auto">
            Complete lessons daily to build your streak. Track your progress, earn achievements, 
            and celebrate your learning milestones with confetti! 🎉
          </p>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="card p-12 relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-br from-primary-500/10 via-transparent to-navy-900" />
