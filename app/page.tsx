...
import LearningStatsTicker from '@/components/LearningStatsTicker'
    ...
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute bottom-40 left-1/4 w-2 h-2 bg-primary-300/25 rounded-full animate-float" />
          <div className="absolute top-60 right-1/3 w-4 h-4 bg-primary-400/15 rounded-full animate-float-delayed" />
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
              Learn skills that
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-400 via-primary-500 to-primary-600 animate-gradient-x"> advance your career</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="#find-your-path" className="btn-secondary text-lg group">
      ...
      {/* Find Your Path Quiz Section */}
      <section id="find-your-path" className="py-20 bg-gradient-to-b from-navy-900/50 to-navy-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <FindYourPath courses={courses} categories={categories} />
        </div>
      </section>
