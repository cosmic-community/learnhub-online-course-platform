        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6 max-w-3xl mx-auto">
            ...
            <div className="text-center bg-navy-900/30 backdrop-blur-sm border border-navy-800 rounded-xl p-4 hover:border-primary-500/30 transition-colors">
              ...
              <div className="text-navy-400 text-sm">Hours Content</div>
            </div>
            <div className="text-center bg-navy-900/30 backdrop-blur-sm border border-navy-800 rounded-xl p-4 hover:border-primary-500/30 transition-colors">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="card p-6 text-center group">
              <div className="w-16 h-16 mx-auto mb-4 bg-primary-500/10 rounded-2xl flex items-center justify-center text-3xl group-hover:scale-110 transition-transform">
                🎯
              </div>
              <h3 className="text-xl font-semibold text-white mb-2">Project-Based Learning</h3>
              <p className="text-navy-400">Build real projects and add them to your portfolio as you learn</p>
            </div>
            <div className="card p-6 text-center group">
              <div className="w-16 h-16 mx-auto mb-4 bg-primary-500/10 rounded-2xl flex items-center justify-center text-3xl group-hover:scale-110 transition-transform">
                🔥
              ...
              <p className="text-navy-400">Stay motivated with daily streaks and milestone achievements</p>
            </div>
            <div className="card p-6 text-center group">
              <div className="w-16 h-16 mx-auto mb-4 bg-primary-500/10 rounded-2xl flex items-center justify-center text-3xl group-hover:scale-110 transition-transform">
                👨‍💻
          ...
          <div className="card p-12 relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <p className="text-navy-300 mb-8 text-lg">
                ...
                Build your streak and never stop growing!
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/courses" className="btn-primary text-lg">
                  Get Started Now
