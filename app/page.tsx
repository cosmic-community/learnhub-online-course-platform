  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute bottom-20 left-20 text-3xl opacity-20 animate-float" style={{ animationDelay: '1s' }}>⚡</div>
        <div className="absolute bottom-40 right-10 text-4xl opacity-20 animate-float" style={{ animationDelay: '1.5s' }}>🎯</div>
        
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center max-w-3xl mx-auto">
            {/* Animated badge */}
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary-500/10 border border-primary-500/30 rounded-full text-primary-400 text-sm font-medium mb-6 animate-shimmer">
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6 max-w-3xl mx-auto">
            <div className="text-center bg-navy-900/30 rounded-2xl p-4 border border-navy-800 hover-lift">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {featuredCourses.map((course, index) => (
              <div key={course.id} className="hover-lift" style={{ animationDelay: `${index * 0.1}s` }}>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-navy-400 max-w-2xl mx-auto">Our platform is designed to help you achieve your learning goals efficiently</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="card p-6 text-center hover-lift">
              ...
              <p className="text-navy-400 text-sm">Learn by building real-world projects that you can add to your portfolio</p>
            </div>
            ...
            <div className="card p-6 text-center hover-lift">
              ...
              <p className="text-navy-400 text-sm">Learn from industry professionals with years of hands-on experience</p>
            </div>
            ...
            <div className="card p-6 text-center hover-lift">
              ...
              <p className="text-navy-400 text-sm">Stay motivated with streaks, achievements, and progress tracking</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {categories.map((category, index) => (
              <div key={category.id} className="hover-lift" style={{ animationDelay: `${index * 0.1}s` }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {instructors.map((instructor, index) => (
              <div key={instructor.id} className="hover-lift" style={{ animationDelay: `${index * 0.1}s` }}>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="card p-12 relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <p className="text-navy-500 text-sm mt-4">No credit card required • Start learning for free</p>
            </div>
          </div>
        </div>
      </section>
