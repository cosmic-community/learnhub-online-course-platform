  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute top-1/4 left-0 w-[400px] h-[400px] bg-teal-500/5 rounded-full blur-3xl animate-float-delayed" />
        
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center max-w-3xl mx-auto">
            {/* Daily Tip - surprise element! */}
            <DailyTip />
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6 max-w-3xl mx-auto">
            <div className="text-center p-4 rounded-xl bg-navy-900/30 backdrop-blur-sm border border-navy-800/50 hover:border-primary-500/30 transition-all duration-300 hover:scale-105">
      ...
      {/* Course Finder Quiz - The Surprise Feature! */}
          ...
          <div className="card p-12 relative overflow-hidden">
            ...
            <div className="relative">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary-500/10 text-primary-400 text-sm font-medium mb-6">
                ...
                <span>Join {Math.floor(Math.random() * 500) + 1000}+ learners this month</span>
              </div>
