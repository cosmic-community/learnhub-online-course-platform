      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-primary-500/10 border border-primary-500/20 rounded-full px-4 py-2 mb-6 animate-pulse-slow">
      ...
      <section className="py-20 bg-navy-900/30">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="card p-12 relative overflow-hidden">
            ...
            <div className="absolute bottom-0 left-0 w-48 h-48 bg-primary-500/10 rounded-full translate-y-1/2 -translate-x-1/2" />
            ...
            <div className="relative">
              ...
              <p className="text-navy-300 mb-8 text-lg">
                ...
                <br />
                <span className="text-primary-400">Build your learning streak and unlock achievements!</span>
              </p>
              <Link href="/courses" className="btn-primary text-lg group">
                Get Started Now
                <span className="ml-2 group-hover:translate-x-1 transition-transform">🎯</span>
