...
export default async function HomePage() {
  ...
  return (
    <div>
          ...
          <div className="mt-16 grid grid-cols-3 gap-8 max-w-2xl mx-auto animate-fade-in-up animation-delay-400">
            <div className="text-center group">
              <div className="text-3xl font-bold text-white group-hover:text-primary-400 transition-colors">
                <span className="counter-animate">{courses.length}</span>+
              </div>
              <div className="text-navy-400 text-sm">Courses</div>
            </div>
            <div className="text-center group">
              <div className="text-3xl font-bold text-white group-hover:text-primary-400 transition-colors">
                <span className="counter-animate">{instructors.length}</span>+
              </div>
              <div className="text-navy-400 text-sm">Expert Instructors</div>
            </div>
            <div className="text-center group">
              <div className="text-3xl font-bold text-white group-hover:text-primary-400 transition-colors">
                <span className="counter-animate">{totalHours}</span>h
              </div>
      ...
      {/* Quick Start Recommendation - New Delightful Feature */}
      <QuickStartRecommendation courses={courses} />

      {/* Achievement Showcase - Gamification Element */}
      <AchievementShowcase 
          ...
          <div className="flex items-center justify-between mb-12">
            <div>
              <h2 className="text-3xl font-bold text-white mb-2 flex items-center gap-3">
                Featured Courses
                <span className="inline-flex items-center justify-center w-8 h-8 bg-primary-500/20 rounded-full">
      ...
      {/* Learning Path Preview - Visual Journey */}
      <LearningPathPreview categories={categories} courses={courses} />
