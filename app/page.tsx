...
export default async function HomePage() {
  ...
  const typingWords = ['advance your career', 'build amazing projects', 'master new skills', 'unlock your potential']
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight animate-fade-in-up" style={{ animationDelay: '100ms' }}>
              Learn skills that
            ...
            <p className="text-xl text-navy-300 mb-8 animate-fade-in-up" style={{ animationDelay: '200ms' }}>
          ...
          <div className="mt-16 animate-fade-in-up" style={{ animationDelay: '400ms' }}>
            <LearningStreak coursesCount={courses.length} lessonsCount={lessons.length} />
          </div>
        </div>
      </section>
