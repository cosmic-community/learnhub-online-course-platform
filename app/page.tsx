    ...
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-20 left-20 w-2 h-2 bg-primary-400/30 rounded-full animate-pulse" />
          <div className="absolute top-40 right-40 w-3 h-3 bg-primary-500/20 rounded-full animate-pulse delay-300" />
          <div className="absolute bottom-40 left-1/4 w-2 h-2 bg-primary-400/25 rounded-full animate-pulse delay-700" />
          <div className="absolute top-1/3 right-1/4 w-4 h-4 bg-primary-500/15 rounded-full animate-pulse delay-500" />
        </div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="card p-8 text-center group hover:-translate-y-1 transition-transform">
              <div className="w-16 h-16 bg-gradient-to-br from-primary-500/20 to-primary-600/20 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform">
                <span className="text-3xl">🎯</span>
              </div>
              <h3 className="text-xl font-semibold text-white mb-3">Structured Learning</h3>
              <p className="text-navy-400">
                Clear, step-by-step curriculum designed by industry experts to take you from beginner to pro.
              </p>
            </div>
            ...
            <div className="card p-8 text-center group hover:-translate-y-1 transition-transform">
              ...
              <p className="text-navy-400">
                Access courses anytime, anywhere. Pause, rewind, and revisit lessons as many times as you need.
              </p>
            </div>
          </div>
        </div>
