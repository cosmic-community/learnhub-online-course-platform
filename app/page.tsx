...
export default async function HomePage() {
  ...
  return (
    <div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-primary-500/10 border border-primary-500/20 rounded-full px-4 py-2 mb-6">
              ...
              <span className="text-primary-400 text-sm font-medium">Track your progress & earn achievements!</span>
            </div>
      ...
      <section className="py-8 bg-gradient-to-r from-primary-500/10 via-purple-500/10 to-primary-500/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap items-center justify-center gap-8 text-center">
            ...
            <div className="flex items-center gap-2">
              <span className="text-2xl">🏆</span>
              <span className="text-white font-medium">Unlock Achievements</span>
            </div>
            <div className="hidden sm:block w-px h-8 bg-navy-700" />
            <div className="flex items-center gap-2">
              <span className="text-2xl">📊</span>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="card p-12 relative overflow-hidden">
            ...
            <div className="mt-6 flex items-center justify-center gap-4 text-navy-400 text-sm">
