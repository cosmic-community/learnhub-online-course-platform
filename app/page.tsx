      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-navy-900/30 backdrop-blur-sm border border-navy-800 rounded-2xl p-8 text-center hover:border-primary-500/30 transition-colors">
              ...
              <p className="text-navy-400">Hands-on projects and real code examples in every course. Practice makes perfect.</p>
            </div>
            ...
            <div className="bg-navy-900/30 backdrop-blur-sm border border-navy-800 rounded-2xl p-8 text-center hover:border-primary-500/30 transition-colors">
              ...
              <p className="text-navy-400">No deadlines, no pressure. Access courses anytime, anywhere, on any device.</p>
            </div>
